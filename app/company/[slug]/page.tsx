      ...
      <main className="flex-1">
        ...
        <section className="py-12 bg-surface" id="related">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                { href: "/industry/finance/", label: "金融×AIキャリアガイド｜年収・求人・企業", category: "業界ガイド" },
                { href: "/industry/ecommerce/", label: "EC・小売×AIエンジニア転職ガイド", category: "業界ガイド" },
                { href: "/industry/advertising/", label: "広告・マーケ×AI転職ガイド", category: "業界ガイド" },
                ...
                { href: "/tech/llm/", label: "LLM/RAG技術で年収アップする方法", category: "技術ガイド" },
